...
## Credits
Original concept and inspiration from the [Nerdy Clock — Binary Clock Using Pico W](https://www.instructables.com/Nerdy-Clock-Binary-Clock-Using-Pico-W/) project on Instructables. This implementation extends the original with NTP time sync, automatic US Daylight Saving Time adjustment, and periodic re-sync.
